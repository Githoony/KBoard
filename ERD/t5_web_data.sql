...
VALUES ('USER1', '$2a$10$YNFO2QMDSGH9F8Y7obnev.8f7NoYmtEIVx3QFcH/z0TpSiW7BjPay', '회원1', 'user1@mail.com'),
       ('USER2', '$2a$10$68I4GOYvgnQEs/mh6zKMAeK1npGDXAhS5YxmSNGIysN8PMWeS3q0e', '회원2', 'user2@mail.com'),
       ('ADMIN1','$2a$10$tIRwwWRHhWTDttz5hZSb8e6YzNYjWxMQ.Gu.3Rh4fGoyzYwu39mC2', '관리자1', 'admin1@mail.com')
;

-- 샘플 사용자-권한
INSERT INTO t5_user_authorities
VALUES (1, 1), # user1 = ROLE_MEMBER
       (3, 1), # user3 = ROLE_MEMBER, ROLE_ADMIN
       (3, 2) # user2 = 권한 없음
;
-- 샘플 글
